...
if __name__ == "__main__":
    ...
    for batch_size in batch_sizes:
        ...
        file = open(folder + "batch_size_results.txt", "a+")
    ...
    for x in ['train', 'val']:
        ...
        for i in range(len(batch_sizes)):
            plt.plot(stats_list[i].epochs[x],  stats_list[i].accuracies[x], label="batch size {}".format(batch_sizes[i]))
        plt.xlabel('epoch')
        plt.ylabel('Accuracy')
        plt.grid(True)
        plt.legend()
        ...
        plt.figure(frameon  = False)
        for i in range(len(batch_sizes)):
            plt.plot(stats_list[i].epochs[x],  stats_list[i].losses[x], label="batch size {}".format(batch_sizes[i]))
        plt.xlabel('epoch')
        plt.ylabel('losses')
        plt.grid(True)
        plt.legend()
